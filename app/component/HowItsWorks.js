          ...
          <div className="lg:space-y-16 md:space-y-10 space-y-8 md:w-[50%]">
            <div className="md:flex space-y-4 md:gap-8">
              ...
              <div className="space-y-4 lg:w-[360px]">
                ...
                <p className="text-md">
                  Our AI-powered request form makes creative briefs a breeze.
                  From built-in stock libraries, to customized brand guides, you
            ...
            <div className="md:flex space-y-4 md:gap-8">
              ...
              <div className="space-y-4 md:w-[360px]">
                ...
                <p className="text-md">
                  ...
                  project. Enjoy same-day turnaround on certain projects with
                  some plans.
                </p>
              </div>
            </div>
            ...
            <div className="md:flex space-y-4 md:gap-8">
              ...
              <div className="space-y-4 md:w-[360px]">
                ...
                <p className="text-md">
                  And if it’s not perfect? No problem! Our platform makes
                  revision feedback simple and concise. Plus, all of our plans
                  include unlimited revisions, and access to all source files.
                </p>
              </div>
            </div>
          </div>

     ...
     <section className="bg-[#ededed] text-[#282b30] lg:px-16 md:px-10 px-5 py-16">
      <div className="md:flex lg:gap-20 md:gap-10 lg:max-w-[1440px] m-0 md:m-auto">
        <div className="md:w-[50%] mb-8">
          <h3 className="text-[#00b1dc] uppercase md:text-base">How it works</h3>
          ...
          <p className="text-[18px] md:mt-6 mt-4">
            Centralize your unlimited graphic design needs with flexible
          ...
          >
            SEE PLAINS
            <span
              ><MoveRight className=" transition duration-200 group-hover:translate-x-1" strokeWidth={2.25} />
            </span>
          </button>
        </div>
        <div className="lg:space-y-16 md:space-y-10 space-y-8 md:w-[50%]">
          <div className="md:flex space-y-4 md:gap-8">
            <div className="lg:w-[100px] md:w-16">
              <span
                ...
                >
                  ...
                  <g fill="#24282b">
                    <path
                      d="M78.2 114.17l-7.38-20a1.43 1.43 0 0 0-.52-.69L20.91 56.22A13 13 0 0 0 .13 68.45a12.94 12.94 0 0 0 5.06 8.6l49.4 37.26a1.46 1.46 0 0 0 .81.3l21.25 1.61h.12a1.53 1.53 0 0 0 1.43-2.06zm-7.11-10.44a18.29 18.29 0 0 0-6.56 8.51l-7.53-.57c.05-3.15 1.19-11.34 11.48-15.06zM54 110.06L12.73 78.91 24.76 63 66.2 94.21a19.1 19.1 0 0 0-11 10.88 19.71 19.71 0 0 0-1.2 4.97zM3.16 68a10 10 0 0 1 15.9-9.36l3.26 2.46-12 15.95L7 74.61A9.93 9.93 0 0 1 3.16 68zm64.56 44.46a15.1 15.1 0 0 1 4.47-5.76l2.32 6.3zm16.5.71h68.29v3.06H84.22zm0-15.52h68.29v3.06H84.22z"
                    ></path>
                  </g>
                  <path
            ...
            <div className="space-y-4 lg:w-[360px]">
              <h3 className="lg:text-[26px] text-[22px]">1. Submit Your Request</h3>
              <p className="text-md">
                Our AI-powered request form makes creative briefs a breeze. From
                built-in stock libraries, to customized brand guides, you
                provide directions on your vision all in one place.
              </p>
            </div>
          </div>
          ...
          <div className="md:flex space-y-4 md:gap-8">
            <div className="lg:w-[100px] md:w-16">
              <span
                ...
                >
                  ...
                  <g fill="#00b1dc">
                    <path
                      d="M90.89 8.41h12.74v12.74H90.89zM36.87 37.56h12.74V50.3H36.87z"
                    ></path>
            ...
            <div className="space-y-4 md:w-[360px]">
              <h3 className="lg:text-[26px] text-[22px]">2. Your Designer Gets to Work</h3>
              <p className="text-md">
                We assign work immediately based on the requirements in your
                project. Enjoy same-day turnaround on certain projects with some
                plans.
              </p>
            </div>
          </div>
          ...
          <div className="md:flex space-y-4 md:gap-8">
            ...
            <div className="space-y-4 md:w-[360px]">
              <h3 className="lg:text-[26px] text-[22px]">3. You've Got a Design</h3>
              <p className="text-md">
                And if it’s not perfect? No problem! Our platform makes revision
                feedback simple and concise. Plus, all of our plans include
                unlimited revisions, and access to all source files.
              </p>
            </div>
          </div>
        </div>

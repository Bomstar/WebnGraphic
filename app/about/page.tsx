        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-center">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <Card className="bg-white border-none shadow-xl rounded-2xl overflow-hidden">
              <div className="h-1 md:h-2 bg-gradient-to-r from-[#00b1dc] to-[#16152f]"></div>
              <CardContent className="p-5 sm:p-6 md:p-8">
                <div className="space-y-4 md:space-y-6 text-gray-700 text-base md:text-lg leading-relaxed">
                  ...
                  <div className="pt-2 md:pt-4">
                    <a
                      href="/about"
                      className="group inline-flex items-center text-[#00b1dc] font-medium hover:text-[#0098c1] transition-colors"
                    >
            ...
            <div className="mt-6 md:mt-8 bg-[#16152f] rounded-xl p-4 sm:p-5 md:p-6 text-white relative">
              ...
              <div className="ml-4 md:ml-6">
                <p className="italic text-sm md:text-base text-gray-300">
                  "WebNGraphic transformed our online presence completely. Their
                  team's creativity and technical expertise exceeded our
                  expectations."
                </p>
